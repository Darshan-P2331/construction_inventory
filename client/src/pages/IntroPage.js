...
const IntroPage = () => {
  return (
    <div className="w-full h-screen flex justify-center items-center text-center text-white">
      <div>
        ...
        <div className="flex items-center justify-evenly mt-4 mb-10">
          <h4 className="text-2xl">Darshan.P (19GANSE010)</h4>
          <h4 className="text-2xl">E.Ram Sanjay (19GANSE015)</h4>
        </div>
        <p className="mt-4">under the guidance of</p>
        <div className="flex items-center justify-evenly mt-4 mb-10">
          <h4 className="text-2xl">Dr Samyama Gunjal</h4>
          <h4 className="text-2xl">Shruti Gupta</h4>
        </div>
        <a
          href="/home"
          className="px-6 py-2 
